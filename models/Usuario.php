<?php
    ...
    class Usuario extends Conectar{
        ...
        public function insert_usuario($usu_nom, $usu_ape, $usu_correo, $usu_pass, $rol_id){
            $conectar = parent::conexion();
            parent::set_names();
            $sql = "INSERT INTO tm_usuario (usu_id, usu_nom, usu_ape, usu_correo, usu_pass, rol_id, fecha_creacion, fecha_modificacion, fecha_elim, est) VALUES (NULL, ?, ?, ?, MD5(?), ?, now(), NULL, NULL, '1');";
